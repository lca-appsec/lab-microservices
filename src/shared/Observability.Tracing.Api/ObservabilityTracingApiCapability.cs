namespace ObservabilityTracingApiCapability;
...
public sealed class ObservabilityTracingApiCapability : ISharedCapability
{
    public string Component => "Observability.Tracing.Api";
