namespace GeoLocationApiCapability;
...
public sealed class GeoLocationApiCapability : ISharedCapability
{
    public string Component => "Geo.Location.Api";
