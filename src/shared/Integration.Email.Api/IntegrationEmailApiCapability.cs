namespace IntegrationEmailApiCapability;
...
public sealed class IntegrationEmailApiCapability : ISharedCapability
{
    public string Component => "Integration.Email.Api";
