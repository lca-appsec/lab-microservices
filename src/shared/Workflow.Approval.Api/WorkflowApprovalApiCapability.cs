namespace WorkflowApprovalApiCapability;
...
public sealed class WorkflowApprovalApiCapability : ISharedCapability
{
    public string Component => "Workflow.Approval.Api";
