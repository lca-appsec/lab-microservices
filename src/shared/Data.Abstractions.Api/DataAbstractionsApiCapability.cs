namespace DataAbstractionsApiCapability;
...
public sealed class DataAbstractionsApiCapability : ISharedCapability
{
    public string Component => "Data.Abstractions.Api";
