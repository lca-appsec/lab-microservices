namespace CacheLocalApiCapability;
...
public sealed class CacheLocalApiCapability : ISharedCapability
{
    public string Component => "Cache.Local.Api";
