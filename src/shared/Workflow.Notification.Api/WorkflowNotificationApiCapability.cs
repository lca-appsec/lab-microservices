namespace WorkflowNotificationApiCapability;
...
public sealed class WorkflowNotificationApiCapability : ISharedCapability
{
    public string Component => "Workflow.Notification.Api";
